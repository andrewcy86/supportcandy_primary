...
<button type="button" class="btn btn-sm wpsc_btn_bulk_action wpsc_action_btn checkbox_depend" id="btn_location_scanner" style="<?php echo $action_default_btn_css?>" onclick="window.location.href = '<?php echo WPPATT_PLUGIN_URL . 'includes/barcode/';?>'"><i class="fas fa-barcode"></i> Barcode Scanner</button>
<?php
}
?>		
  </div>
